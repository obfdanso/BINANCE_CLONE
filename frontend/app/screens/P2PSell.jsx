...
export default function P2PSell() {
    ...
    // Get connected mobile money payment methods and add Bank Transfer
    const connectedMobileMoney = getConnectedMobileMoney().map(mobile => mobile.name);
    const paymentMethods = ['Bank Transfer', ...connectedMobileMoney];
    ...
    // Calculate USD amount when USDT amount changes
    useEffect(() => {
        if (amount && price) {
            const usdAmount = (parseFloat(amount) * parseFloat(price)).toFixed(2);
    ...
    const handleSellPress = () => {
        ...
        const userAmount = parseFloat(calculatedUSD);

        console.log('Max limit:', maxLimit, 'User amount:', userAmount);
            ...
            <View style={styles.descriptionBox}>
                <View style={styles.descriptionContent}>
                    ...
                    <Text style={styles.descriptionText}>
                        Complete your sale to {trader} using your preferred payment method
                    </Text>
                </View>
            </View>
                            ...
                            >
                                <View style={styles.paymentMethodContent}>
                                    <Ionicons
                                        ...
                                        size={20}
                                        color={selectedPaymentMethod === method ? RED : '#aaa'}
                                    />
                                    <Text style={[
                            ...
                            <View style={styles.modalBody}>
                                ...
                                <View style={styles.warningBox}>
                                    ...
                                    <Text style={styles.warningText}>
                                        Please ensure you have the USDT ready. The trader will contact you shortly.
                                    </Text>
                                </View>
                            </View>
                ...
                <View style={styles.modalOverlay}>
                    <View style={styles.simpleOverlay}>
                        <View style={styles.modalContent}>
                            ...
                            <View style={styles.modalBody}>
                                <Ionicons name="check-circle" size={60} color={RED} style={styles.successIcon} />
                                <Text style={styles.successMessage}>Your sell order has been created.</Text>
