...
const SpotIsolatedMarginScreen = () => {
  ...
  return (
    <SafeAreaView style={[styles.safeArea, { paddingTop: insets.top }]}>
      ...
      <View style={styles.tabs}>
        ...
        <Text style={styles.tabActive}>Isolated Margin</Text>
      ...
      <ScrollView contentContainerStyle={styles.scrollContent}>
        ...
        {/* Isolated Margin Info */}
        <View style={styles.infoCard}>
          <View style={styles.infoHeader}>
            <MaterialCommunityIcons name="shield-check" size={iconSize.xl} color={GREEN} />
            <Text style={styles.infoTitle}>Isolated Margin</Text>
          </View>
          <Text style={styles.infoDescription}>
            Isolated margin allows you to trade with leverage while limiting your risk to a specific position.
          ...
          <View style={styles.infoStats}>
            ...
            <View style={styles.statItem}>
              ...
              <Text style={styles.statValue}>$850.00</Text>
            </View>
          </View>
        </View>
        ...
        <View style={styles.positionCard}>
          <View style={styles.positionHeader}>
            <MaterialCommunityIcons name="ethereum" size={iconSize.xl} color="#627EEA" />
            <View style={styles.positionInfo}>
              <Text style={styles.positionSymbol}>ETH/USDT</Text>
              <Text style={styles.positionType}>Long</Text>
            </View>
            <View style={styles.positionStats}>
              <Text style={styles.positionSize}>0.5 ETH</Text>
              <Text style={styles.positionValue}>$1,785.31</Text>
            </View>
          </View>
          <View style={styles.positionDetails}>
            <View style={styles.detailRow}>
              <Text style={styles.detailLabel}>Entry Price</Text>
              <Text style={styles.detailValue}>$3,570.62</Text>
            </View>
            <View style={styles.detailRow}>
              <Text style={styles.detailLabel}>Mark Price</Text>
              <Text style={styles.detailValue}>$3,571.62</Text>
            </View>
            <View style={styles.detailRow}>
              <Text style={styles.detailLabel}>P&L</Text>
              <Text style={[styles.detailValue, { color: GREEN }]}>+$0.50 (+0.03%)</Text>
            </View>
            <View style={styles.detailRow}>
              <Text style={styles.detailLabel}>Leverage</Text>
              <Text style={styles.detailValue}>5x</Text>
            </View>
          </View>
...
export default SpotIsolatedMarginScreen; 